    ...
    <div className="p-4 md:p-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">
          {t("dashboard_driver.title")}
        </h1>
        <p className="text-gray-500">{t("dashboard_driver.description")}</p>
      </div>
            ...
            <div className="flex items-start">
              <div className="flex-1">
                <p className="text-gray-500 text-sm">
                  {t("dashboard_driver.assignedVehicles")}
                </p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start">
              <div className="flex-1">
                <p className="text-gray-500 text-sm">
                  {t("dashboard_driver.upcomingMaintenance")}
                </p>
                <h3 className="text-2xl font-bold mt-1 text-gray-800">
                  {maintenanceLoading ? (
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-start">
              <div className="flex-1">
                <p className="text-gray-500 text-sm">
                  {t("dashboard_driver.overdueTasks")}
                </p>
                <h3 className="text-2xl font-bold mt-1 text-gray-800">
                  {maintenanceLoading ? (
                    <div className="h-8 w-8 bg-gray-200 animate-pulse rounded"></div>
                ...
                {overdueMaintenance && overdueMaintenance.length > 0 && (
                  <p className="text-red-500 text-sm mt-1 flex items-center">
                    ...
                    {t("dashboard_driver.requiresAttention")}
                  </p>
                )}
              </div>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold text-gray-800">
            {t("dashboard_driver.myVehicles")}
          </h2>
          <Link to="/maintenance">
            <a className="text-primary text-sm flex items-center">
              {t("dashboard_driver.viewAllMaintenance")}
                    ...
                    <div className="space-y-2 mb-3">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500">
                          {t("dashboard_driver.vinPrefix")}
                        </span>
                        <span className="text-gray-900">{vehicle.vin}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500">
                          {t("dashboard_driver.licensePrefix")}
                        </span>
                        <span className="text-gray-900">
                          {vehicle.licensePlate || t("dashboard_driver.na")}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500">
                    ...
                    <Link to={`/vehicle/${vehicle.id}`}>
                      <a className="w-full">
                        <Button variant="outline" className="w-full">
                          ...
                          {t("dashboard_driver.viewDetails")}
                        </Button>
                      </a>
                    </Link>
                  </div>
            ...
            <div className="col-span-3 text-center py-10">
              <div className="flex flex-col items-center justify-center">
                ...
                <h3 className="text-lg font-medium text-gray-700">
                  {t("dashboard_driver.noVehiclesAssigned")}
                </h3>
                <p className="text-gray-500 mt-1">
                  {t("dashboard_driver.noVehiclesDesc")}
                </p>
              </div>
            </div>
          )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-4">
            {t("dashboard_driver.overdueMaintenance")}
          </h2>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex flex-col items-center justify-center py-6">
                  <span className="material-icons text-3xl text-green-500 mb-2">
                    check_circle
                  </span>
                  <h3 className="text-lg font-medium text-gray-700">
                    {t("dashboard_driver.noOverdueTasks")}
                  </h3>
                  <p className="text-gray-500 mt-1">
                    {t("dashboard_driver.allCaughtUp")}
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-4">
            {t("dashboard_driver.upcomingTasks")}
          </h2>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="text-lg font-medium text-gray-700">
                    {t("dashboard_driver.noUpcomingTasks")}
                  </h3>
                  <p className="text-gray-500 mt-1">
                    {t("dashboard_driver.noUpcomingDesc")}
                  </p>
                </div>
              </CardContent>
            </Card>
